...
function premiumPT() {
  ...
  am("Clique e conheça os planos:", [{ l: "Quero ser Premium", p: 1, a: () => showRedirectLoading('https://frameag.com/premium', true) }, { l: "Voltar", a: menuContratantePosIdade }], 800);
}
...
function verificacaoContratante() {
  ...
  am("Contratantes também podem ser verificados em caso de denuncias ou pendências cadastrais.", [{ l: "Entendi", a: ctPT }], 800);
}
