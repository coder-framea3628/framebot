...
function problemaCodigo() {
  ...
  am("1. <span class='semibold'>Verifique a caixa de spam</span> ou lixo eletrônico no seu e-mail.<br>2. <span class='semibold'>Confirme se o e-mail cadastrado está correto</span> no site.<br>3. <span class='semibold'>Aguarde alguns minutos</span>, pois pode haver atraso.<br>4. <span class='semibold'>Tente reenviar o código</span> diretamente pela página de cadastro.");
