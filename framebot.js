...
function falhaAuthentic() {
  am("Certifique-se de utilizar uma boa iluminação e manter o rosto nítido, sem óculos, chapéu ou acessorios. Verifique sua conexão e tente novamente após o prazo estipulado na tela ou fale conosco.", null, 0);
  am("Falar com suporte: <a href='https://t.me/suporteframebot' class='link'>Telegram</a>", [{ l: "Voltar", a: cadastroPT }], 800);
  perguntarSatisfacao();
}
...
function premiumPT() {
  am("Torne-se Premium e desbloqueie tudo! • Catálogo completo sem anúncios.<br>• FramePay com lounges VIP e hotéis parceiros. • Atendimento prioritário 24h.", null, 0);
...
function verificacaoContratante() {
  am("Frame Authentic: Sua Proteção Garantida. Verificação facial ao vivo, (documentos + selfie). Resultado: Zero fraudes, perfis 100% reais.", null, 0);
...
function gerenciarPerfil() {
  am("Na sua BrandPage, você pode editar suas fotos, bio, medidas e adicionar redes sociais. Adquira destaque no catálogo Premium e acompanhe visualizações/agendamentos.", null, 0);
  am("Acesse sua <a href='https://frameag.com/login' class='link'>Área Login</a>", [{ l: "Voltar", a: crPT }], 800);
}

function framePayments() {
  am("Com o Frame Payments você recebe valores direto na carteira com seu Bot no Telegram para quitação instantânea. Livre de % da Frame, lucro 100% seu e verificação antes do pagamento.", null, 0);
