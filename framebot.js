...
<div class="c" id="cb">
<div class="h"><img src="https://framerusercontent.com/images/uvgx4LpdArstEFjK7yhfEcgIEo.png">Atendimento | Frame<div class="m" onclick="ec()">&larr; Voltar</div></div>
<div class="b" id="bd"></div>
<div class="f">Ao continuar,<br>você concorda com os <a href="https://frameag.com/termos" target="_blank" class="link">Termos e Condições</a>.</div>
</div>
<div class="o" id="ov"><div class="oc"><p>Finalizar atendimento?</p><button onclick="ec()">Finalizar</button></div></div>
<script>
const b=document.getElementById('bd'),p="https://framerusercontent.com/images/uvgx4LpdArstEFjK7yhfEcgIEo.png";
function am(t,btn){let m=document.createElement('div');m.className='msg';let i=document.createElement('img');i.src=p;let bb=document.createElement('div');bb.className='bb';bb.innerHTML=t+'<span class="bt">agora</span>';if(btn){let w=document.createElement('div');w.className='btns';btn.forEach(o=>{let b2=document.createElement('div');b2.className='btn'+(o.p?' p':'');b2.innerText=o.l;b2.onclick=o.a;w.appendChild(b2)});bb.appendChild(w)}m.append(i,bb);b.appendChild(m);b.scrollTop=b.scrollHeight;}
function menu(){b.innerHTML='<div class="l">Chat ao vivo</div>';am("Me conta, qual é a sua relação com a Frame hoje?",[{l:"Contratante / Assinante",p:1,a:cm},{l:"Criadora / Anunciante",a:cr}]);}
function cm(){b.innerHTML='<div class="l">Chat ao vivo</div>';am("Selecione uma opção:",[
...
{l:"Falar com humano",a:fh},{l:"Voltar",a:menu}
]);}
function cr(){b.innerHTML='<div class="l">Chat ao vivo</div>';am('Acesse a <a href=https://frameag.com/login target=_blank class=link>Área de Login</a> e clique em Suporte - Frame Girl');}
function ct(){b.innerHTML='<div class="l">Chat ao vivo</div>';am("Você possui 18 anos ou mais?",[
...
{l:"Não",a:()=>am("A Frame é exclusiva para maiores de 18 anos.")}
]);}
function om(){ov.style.display='flex'}
...
onload=()=>{b.innerHTML='<div class="l">Chat ao vivo</div>';am("Olá, bem-vindo :)");setTimeout(()=>am("Selecione seu idioma:",[{l:"Português",p:1,a:menu},{l:"English",a:menu},{l:"Español",a:menu}]),600);}
</script>