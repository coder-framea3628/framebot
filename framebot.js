...
function problemaCodigo() {
  ...
  // Introdução
  am("Se o código de ativação do cadastro não chegou em sua caixa de entrada, siga estas etapas:", null, 500);
  am("<b>1. Verifique a caixa de spam ou lixo eletrônico:</b> às vezes o e-mail pode estar lá.", null, 1000);
  am("<b>2. Confirme se o e-mail cadastrado está correto:</b> um endereço digitado errado impede o recebimento.", null, 1500);
  am("<b>3. Aguarde alguns minutos:</b> em certos casos o envio pode demorar um pouco mais.", null, 2000);
  am("<b>4. Reenvie o código de ativação:</b> utilize a opção no site para solicitar um novo envio.", null, 2500);

  // Pergunta final com botões
