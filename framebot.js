...
function crPT() {
  ...
  am("Para se cadastrar, acesse <a href=https://frameag.com/login target=_blank class=link>frameag.com/login</a> e siga as instruções. O processo é rápido e seguro.");
  am("É necessário ter mais de 18 anos, passar pelo Frame Authentic e concordar com os Termos e Condições.");
