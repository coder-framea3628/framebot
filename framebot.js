...
function processUserMessage(text) {
  ...
  if (t === '/dados' && isAdmin) {
    am(`Usuários: ${localStorage.getItem('userInfo') ? 1 : 0}
...
function openFaqPopup() {
  ...
  helpDiv.textContent = 'Não encontrou sua dúvida?';
  const btn = document.createElement('button');
  btn.className = 'btn p';
...
function finalizeChat() {
  am('Deseja finalizar esse chat de atendimento? Sem problemas! Fico a disposição para te ajudar sempre que precisar.', 300, [
