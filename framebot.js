...
function menuPT() {
  ...
  am("Me conta, qual é a sua relação com a Frame hoje?", [
    ...
    { l: "Quero me tornar premium", a: premiumPT }
  ], 800);
}
function cmPT() {
  b.innerHTML = '<div class="l">Chat ao vivo</div>';
...
// ===== Novo fluxo premium =====
function premiumPT() {
  am("É uma ótima escolha.", null, 0);
  am("No premium você desbloqueia vantagens que ninguém mais pode ter.", null, 700);
  am("Como, por exemplo, o catálogo completo, galerias, sexe e atendimento prioritário.", null, 1400);
  am("Para se tornar premium, clique abaixo.", [{ l: "Quero ser premium", p: 1, a: () => window.open('https://frameag.com/premium','_blank') }], 2100);
}
