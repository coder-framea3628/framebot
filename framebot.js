...
<div class="sheet-overlay" id="feedbackSheet" role="dialog" aria-modal="true" aria-label="Avaliação de experiência">
  <div class="sheet-container">
    <div class="sheet-handle"></div>
    <div class="sheet-title">Como foi sua experiência no chat?</div>
...
const notUnderstoodVariations = [
  ...
  'Hmm, não captei bem o que você precisa. Me conta com mais detalhes ou escolha uma opção abaixo.',
...
const inactivityVariations = [
  ...
  'Ei{nome}, sumiu! 😄 Tem mais alguma dúvida? Fico a disposição para ajudar você.'
];
...
function startChatFlow() {
  ...
  if (userInfo) {
    ...
    const g = getGreeting();
    typingShownThisFlow = false;
    am(`${g}, ${nome}! Que bom ver você aqui novamente. Como posso ajudar hoje?`, null, 0);
    setTimeout(() => {
...
function crPT() {
  ...
  am('Como você é uma criadora, posso ajudar com os assuntos abaixo:', [
    { l: 'Como me cadastrar', a: () => {
      typingShownThisFlow = false;
      am('Acesse <a href="https://frameag.com/cadastro" target="_blank" rel="noopener noreferrer" class="link">frameag.com/cadastro</a> e siga as instruções. O processo é simples, seguro e direto aqui no site.');
      setTimeout(perguntarSatisfacao, 600);
    }},
