...
const emojis = [
  ...
  {emoji: '🤣', name: 'rolando no chão de rir'},
  ...
  {emoji: '😊', name: 'rosto sorridente com olhos sorridentes'},
  {emoji: '😋', name: 'rosto saboreando comida'},
  {emoji: '😎', name: 'rosto sorridente com óculos de sol'},
  ...
  {emoji: '🤗', name: 'rosto abraçando'},
  {emoji: '🤩', name: 'rosto com olhos de estrela'},
  {emoji: '🤔', name: 'rosto pensando'},
  {emoji: '🤨', name: 'rosto com sobrancelha levantada'},
  {emoji: '😐', name: 'rosto neutro'},
  {emoji: '😑', name: 'rosto inexpressivo'},
  {emoji: '😶', name: 'rosto sem boca'},
  {emoji: '🙄', name: 'rosto com olhos revirando'},
  {emoji: '😏', name: 'rosto presunçoso'},
  {emoji: '😣', name: 'rosto perseverante'},
  {emoji: '😥', name: 'rosto triste mas aliviado'},
  {emoji: '😮', name: 'rosto com boca aberta'},
  {emoji: '🤐', name: 'rosto com zíper na boca'},
  {emoji: '😯', name: 'rosto surpreso'},
  {emoji: '😪', name: 'rosto sonolento'},
  {emoji: '😫', name: 'rosto cansado'},
  {emoji: '😴', name: 'rosto dormindo'},
  {emoji: '😌', name: 'rosto aliviado'},
  {emoji: '😛', name: 'rosto mostrando a língua'},
  {emoji: '😜', name: 'rosto piscando mostrando a língua'},
  {emoji: '😝', name: 'rosto apertando olhos mostrando a língua'},
  {emoji: '🤤', name: 'rosto babando'},
  {emoji: '😒', name: 'rosto descontente'},
  {emoji: '😓', name: 'rosto com suor frio'},
  {emoji: '😔', name: 'rosto pensativo'},
  {emoji: '😕', name: 'rosto confuso'},
  {emoji: '🙃', name: 'rosto de cabeça para baixo'},
  {emoji: '🤑', name: 'rosto com olhos de dinheiro'},
  {emoji: '😲', name: 'rosto atônito'},
  {emoji: '🙁', name: 'rosto ligeiramente franzido'},
  {emoji: '😖', name: 'rosto confuso'},
  {emoji: '😞', name: 'rosto decepcionado'},
  {emoji: '😟', name: 'rosto preocupado'},
  {emoji: '😤', name: 'rosto com vapor saindo do nariz'},
  {emoji: '😢', name: 'rosto chorando'},
  {emoji: '😭', name: 'rosto chorando alto'},
  {emoji: '😦', name: 'rosto franzindo a testa com boca aberta'},
  {emoji: '😧', name: 'rosto angustiado'},
  {emoji: '😨', name: 'rosto amedrontado'},
  {emoji: '😩', name: 'rosto exausto'},
  {emoji: '🤯', name: 'cabeça explodindo'},
  {emoji: '😬', name: 'rosto fazendo careta'},
  {emoji: '😰', name: 'rosto ansioso com suor'},
  {emoji: '😱', name: 'rosto gritando de medo'},
  {emoji: '🥵', name: 'rosto quente'},
  {emoji: '🥶', name: 'rosto frio'},
  {emoji: '😳', name: 'rosto ruborizado'},
  {emoji: '🤪', name: 'rosto maluco'},
  {emoji: '😵', name: 'rosto tonto'},
  {emoji: '😡', name: 'rosto furioso'},
  {emoji: '😠', name: 'rosto zangado'},
  {emoji: '🤬', name: 'rosto com símbolos na boca'},
  {emoji: '😷', name: 'rosto com máscara médica'},
  {emoji: '🤒', name: 'rosto com termômetro'},
  {emoji: '🤕', name: 'rosto com atadura na cabeça'},
  {emoji: '🤢', name: 'rosto nauseado'},
  {emoji: '🤮', name: 'rosto vomitando'},
  {emoji: '🤧', name: 'rosto espirrando'},
  {emoji: '🥳', name: 'rosto festejando'},
  {emoji: '🥴', name: 'rosto embriagado'},
  {emoji: '🥺', name: 'rosto implorando'},
  {emoji: '🤠', name: 'rosto com chapéu de caubói'},
  {emoji: '🤡', name: 'rosto de palhaço'},
  {emoji: '🤥', name: 'rosto mentiroso'},
  {emoji: '🤫', name: 'rosto fazendo shh'},
  {emoji: '🤭', name: 'rosto com mão sobre a boca'},
  {emoji: '🧐', name: 'rosto com monóculo'},
  {emoji: '🤓', name: 'rosto nerd'},
  {emoji: '😈', name: 'rosto sorridente com chifres'},
  {emoji: '👿', name: 'rosto zangado com chifres'},
  {emoji: '👍', name: 'polegar para cima'},
  {emoji: '👎', name: 'polegar para baixo'},
  {emoji: '✌️', name: 'vitória'},
...
function processUserMessage(text) {
  ...
  if (keywords.definicoes.test(t)) {
    am(`A Frame é uma plataforma especializada em conectar criadoras de conteúdo com contratantes, oferecendo ferramentas de gestão, promoção e segurança. Atuamos como provedora de tecnologia, sem intermediar negociações diretas.${isPositive ? ' Legal, né?' : ''}`);
    perguntarSatisfacao();
    return;
  }
  ...
  if (keywords.cancelamento.test(t)) {
    am(`Para cancelamentos de renovação automática, revise os termos e solicite via email para: contato@frameag.com.${isPositive ? ' 😊' : ''}`);
    perguntarSatisfacao();
    return;
  }
  ...
  if (keywords.ajuda.test(t)) {
    am('Aqui vai uma lista de tópicos que posso ajudar: segurança, cadastro, premium, suporte humano, criadora, contratante, denúncia, termos, dados pessoais. Digite um deles para mais infos!');
    return;
  }
...
function premiumPT() {
  am("No Premium, você desbloqueia vantagens exclusivas que elevam sua experiência na Frame.", null, 0);
  am("Acesso ao catálogo completo sem anúncios, galerias sexy exclusivas, atendimento prioritário 24h e análises personalizadas para melhores escolhas.", null, 800);
  am("Para se tornar Premium e conhecer todos os benefícios em detalhes, clique abaixo:", [{ l: "Quero ser Premium", p: 1, a: () => { showRedirectLoading('https://frameag.com/premium', true); } }], 1600);
}
...
function ctPT() {
  am("Antes de prosseguirmos, confirme se você possui 18 anos ou mais, pois nossos serviços são exclusivos para maiores de idade.", [
    { l: "Sou maior de 18 anos", p: 1, a: () => { 
        am('Ótimo! Antes de contratar, explore todas as modelos em nosso catálogo completo: <a href="https://frameag.com/models" target="_blank" class="link">frameag.com/models</a>. Lá você encontra perfis verificados e opções detalhadas.', null, 0);
        am("Se já decidiu qual modelo contratar, fale diretamente com nosso time para discutir os detalhes com segurança:", [{ l: "Ir para atendimento 24h", p: 1, a: () => { showRedirectLoading('https://t.me/suporteframebot?start=catalogo-site', true); } }], 800);
        setTimeout(perguntarSatisfacao, 1600);
      }},
    { l: "Sou menor", a: () => { 
...
function crPT() {
  am("Certo! Como criadora/anunciante, veja como posso ajudar você.", null, 0);
  am("Selecione uma opção abaixo para prosseguirmos:", [
    ...
    { l: "Termos e condições", a: () => { 
        am("Nossos Termos e Condições detalham como usamos e protegemos seus dados. Você pode acessá-los em <a href=\"https://frameag.com/termos\" target=\"_blank\" class=\"link\">frameag.com/termos</a>.");
        perguntarSatisfacao();
      }},
    { l: "Como funciona o Frame", a: () => { 
...
function validateAge() {
  ...
  if (age >= 18) {
    ...
    showWarningPopup('Desculpe, você deve ter 18 anos ou mais para acessar.');
  }
}
