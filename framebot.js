...
.input-box{display:flex;align-items:center;gap:8px;margin:8px;padding:8px 12px;background:#AC865C;border-radius:20px}
.input-box input{border:none;outline:none;flex:1;background:none;color:#fff;font-size:13px}
