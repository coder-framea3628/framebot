...
<div class="sheet-overlay" id="faqSheet" role="dialog" aria-modal="true" aria-label="Perguntas Frequentes">
  <div class="sheet-container" style="max-height:88vh; overflow-y:auto;">
    ...
    <div class="faq-sheet-content">
      ...
      <button class="faq-start-btn" onclick="closeFaqSheet(); if(!userInfo){ startChatFlow(); } else { inicio(); }">Não encontrou? Fale com a Fabi</button>
    </div>
  </div>
</div>
...
function setupFaqSheet() {
  const faqs = [
    { q: 'O que é a Frame Agency?', a: 'A Frame Agency é uma plataforma completa que em conecta criadoras a contratantes, oferecendo ferramentas de gestão de perfis, anúncios e interações seguras. Atuamos como provedora de tecnologia com recursos de segurança.' },
    ...
    { q: 'É seguro contratar na Frame Agency?', a: 'Sim. Todas criadoras, modelos e acompanhantes da plataforma passam por um processo rigoroso de verificação de identidade realizado mensalmente. Para mais detalhes, acesse: frameag.com/verificacao' },
    { q: 'Como denuncio algo suspeito?', a: 'Use o formulário disponível em: frameag.com/report para reportar anonimamente. Nosso time de segurança 24h analisa rapidamente e toma as medidas necessárias.' },
    { q: 'Meus dados estão seguros?', a: 'Sim. Usamos criptografia avançada, cumprindo a GPDR e LGPD. Os seus dados são usados apenas para o necessário (como manter sua conta ativa) e você pode solicitar acesso ou exclusão quando desejar.' },
    { q: 'A Frame oferece suporte em idiomas além do português?', a: 'Claro! Também oferecemos suporte nativo em espanhol e inglês para usuários. Além disso, graças à tecnologia da plataforma, conseguimos atender novos idiomas a cada dia.' },
