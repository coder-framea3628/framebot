...
function am(t, btn) {
  ...
  bb.className = 'bb';
  bb.innerHTML = t + '<span class="bt">agora</span>';
  if (btn) {
...
function cr() {
  b.innerHTML = '<div class="l">Chat ao vivo</div>';
  am('Acesse a <a href=https://frameag.com/login target=_blank class=link>Área de Login</a> e clique em Suporte - Frame Girl');
}
