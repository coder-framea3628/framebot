...
<div class="o" id="ageConfirmOverlay" role="dialog" aria-modal="true">
  <div class="oc" style="align-items: center; text-align: center;">
    ...
    <p style="color: var(--text-color); font-weight: 500;">Confirme sua data de nascimento para validar sua maioridade</p>
...
function cmPT() {
  ...
  am("Selecione uma opção abaixo para prosseguirmos:", [
    ...
    { l: "Reportar modelo anonimamente", a: () => {
        am('Na Frame, levamos segurança muito a sério. Caso encontre irregularidades em anúncios do nosso site, acesse <a href='https://frameag.com/report' class='link'>https://frameag.com/report</a> e denuncie anonimamente. Sua contribuição é importante para manter nossa comunidade segura.');
      }},
...
function erroCodigo() {
  am("Inseriu o código e ele estava inválido? 1) Verifique se copiou o código recebido por e-mail corretamente. 2) Tente reenviar ou utilize outro email/dispositivo na Área do código.", null, 0);
  am("Problema persiste? Vídeo tutorial: <a href='https://frameag.com/ajuda/cadastro' class='link'>Assista aqui</a> ou fale com nosso time de atendimento abaixo:", 
...
function openFaqPopup() {
  ...
  const faqs = [
    ...
    { q: "Cadastro | Como me tornar criadora?", a: "Para se cadastrar na Frame, você precisa ter mais de 18 anos, fornecer documentos, uma selfie e passar pela verificação facial. O processo é simples e pode ser iniciado no nosso site." },
    ...
    { q: "Como funciona o Frame Premium?", a: "Com o Premium, você acessa o catálogo completo sem anúncios, tem suporte prioritário e benefícios como acesso a lounges VIP e hotéis parceiros da Frame Agency." },
