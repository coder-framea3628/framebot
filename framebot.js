...
function processUserMessage(text) {
  ...
  if (keywords.pagamento.test(t)) {
    am(`Para dúvidas sobre pagamentos, acesse sua área de login ou entre em contato com o time via <a href="mailto:contato@frameag.com" class="link">contato@frameag.com</a> .${isPositive ? ' Vamos resolver rapidinho!' : ''}`);
    perguntarSatisfacao();
    return;
  }
...
function cmPT() {
  ...
  am("Selecione uma opção abaixo para prosseguirmos:", [
    ...
    { l: "Sobre segurança", a: () => { 
        am('Você pode ter se perguntado se a Frame é segura, e sim, é. Aqui, garantimos autenticação em três etapas e contamos com um time de segurança disponível 24h. Saiba mais detalhes em nosso  <a href="Blog de Verificação." target="_blank" class="link">frameag.com/premium</a> ');
