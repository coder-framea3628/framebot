...
function processUserMessage(text) {
  ...
  if (keywords.criadora.test(t)) {
    ...
    am(`Criadoras podem ser agenciadas, recebendo suporte completo, ou anunciantes independentes com ferramentas de anúncio. Para se cadastrar, acesse <a href="https://frameag.com/cadastro" target="_blank" class="link">frameag.com/cadastro</a>, confirme ser maior de 18 anos e passe pelo Frame Authentic.${isPositive ? ' Vamos nessa!' : ''}`);
    perguntarSatisfacao();
    return;
  }
...
function problemaEmail() {
  ...
  am("1. <span class='semibold'>Tente recuperar a conta de e-mail</span> diretamente no provedor (como Gmail ou Outlook). 2. <span class='semibold'>Se não for possível</span>, podemos ajudar a atualizar o e-mail na sua conta Frame.");
...
function problemaLogin() {
  ...
  am("Se ainda tiver dúvidas, assista ao nosso vídeo tutorial completo: <a href='https://frameag.com/ajuda/cadastro' target='_blank' class='link'>https://frameag.com/ajuda/cadastro</a>. Ele cobre tudo desde o início.");
