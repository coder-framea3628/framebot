...
<div id="emojiOverlay" style="display:none;">
  <div class="oc">
    ...
    <input type="text" id="emojiSearch" placeholder="Buscar emoji..." oninput="filterEmojis()" style="font-size: 16px;">
...
<div class="o" id="ageConfirmOverlay" role="dialog" aria-modal="true">
  <div class="oc" style="align-items: center; text-align: center;">
    ...
    <p style="color: var(--text-color); font-weight: 500;">Confirme sua data de nascimento no botão abaixo para validarmos sua maioridade</p>
...
function validateAge() {
  ...
  if (age >= 18) {
    ...
    showWarningPopup('Idade não adequada! Você deve ter ao menos 18 anos para acessar o ecossistema da Frame Agency.');
  }
}
