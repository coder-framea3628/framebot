...
<div style="display: flex; flex-direction: column; align-items: center; gap: 12px; width: 100%;">
  <label for="birthDate" style="font-weight: 500; color: var(--text-color);">Data de nascimento</label>
  
  <div style="position: relative; width: 80%;">
    <input type="date" id="birthDate" aria-label="Data de nascimento" 
      style="color: var(--accent-color); font-weight: 600; border: 1px solid var(--accent-light); border-radius: 10px; padding: 14px 16px; font-size: 16px; text-align: center; width: 100%; background-color: #fff;">
    
    <!-- Botão "Selecionar" visível sobreposto -->
    <button type="button" onclick="document.getElementById('birthDate').showPicker?.()" 
      style="position: absolute; inset: 0; background: transparent; border: none; color: var(--accent-light); font-weight: 600; font-size: 15px; cursor: pointer;">
      Selecionar
    </button>
  </div>

  <button onclick="validateAge()" class="btn p" 
    style="margin-top: 8px; padding: 14px 24px; font-weight: 600; font-size: 15px; width: 80%; background: var(--accent-light); color: #fff; border-radius: 10px;">
    Confirmar Idade
  </button>
</div>
</div>
