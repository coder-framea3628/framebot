...
<div class="o" id="ageConfirmOverlay" role="dialog" aria-modal="true">
  <div class="oc">
    ...
    <p>Confirme sua data de nascimento no para validar maioridade</p>
...
function validateAge() {
  ...
  if (age >= 18) {
    ...
    removeBlock();
    closeAgeConfirm();
    am('Idade confirmada com sucesso! Agora você pode continuar clicando m=em "Iniciar atendimento".');
  } else {
